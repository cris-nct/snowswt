...
public class A2Phase3 extends AbstractPhaseProcessor<AttackData2> {
    ...
    protected A2Phase3(FlagsConfiguration flagsConfiguration, Rectangle screenBounds, IAttack2Global attack2Global) {
    ...
    protected void prepareNextPhase(Snowflake snowflake) {
        ...
        attackData.setLocationToFollow(Utils.moveToDirection(getFlagsConfiguration().getMouseLoc(), 250, direction));
    }
